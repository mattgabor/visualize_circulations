...
class MasterViewController: UITableViewController, PNChartDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        case "lineChart":
            ...
            let lineChartWidth: CGFloat = 300.0
            let lineChartHeight: CGFloat = 300.0
            ...
            viewController.title = "Mission Peak Visitors"
...
//            })
    ...
    {
        print("Click Key on line \(point.x), \(point.y) line index is \(lineIndex) and point index is \(keyPointIndex)", terminator: "")
    }
    
    func userClickedOnLinePoint(point: CGPoint, lineIndex: Int)
    {
        print("Click Key on line \(point.x), \(point.y) line index is \(lineIndex)", terminator: "")
    }
    
    func userClickedOnBarChartIndex(barIndex: Int)
    {
        print("Click  on bar \(barIndex)", terminator: "")
    }
